...
from messaging_sdk.database import Base, SearchVector
...
if TYPE_CHECKING:
    from messaging_sdk.models.call import Call, CallParticipant, CallInvitation
...
class User(Base):
    ...
    search_vector: Mapped[Optional[Any]] = mapped_column(SearchVector, nullable=True)
