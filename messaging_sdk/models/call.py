...
from messaging_sdk.database import Base, JSONType
...
class CallParticipant(Base):
    ...
    participant_metadata: Mapped[Dict[str, Any]] = mapped_column("metadata", JSONType, nullable=False, default=dict, server_default="{}")
